...
- [ ] **Step 1: Write failing KMS provider tests**
...
- [ ] **Step 2: Write failing configuration and factory tests**
...
- [ ] **Step 1: Add the minimal provider contract**
...
- [ ] **Step 2: Implement atomic encrypted-key persistence**
...
- [ ] **Step 3: Implement source selection in `build_master_key_provider`**
...
- [ ] **Step 4: Run focused provider tests to verify GREEN**
...
- [ ] **Step 1: Add typed KMS settings and environment parsing**
...
- [ ] **Step 2: Pass validated settings into application startup**
...
- [ ] **Step 3: Add opt-in integration coverage and documentation**
...
- [ ] **Step 4: Run configuration, wiring, and opt-in tests**
...
- [ ] **Step 1: Run focused, full, Web, syntax, and CodeGraph checks**
