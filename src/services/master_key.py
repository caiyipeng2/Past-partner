...
def build_master_key_provider(
    ...
    *,
    ...
    if MASTER_KEY_ENV_VAR in environment:
    ...
    # an injected key now and can add a KMS-backed provider behind this contract later.
    if mode == "development" and current_platform == "nt":
